[![Release](https://img.shields.io/github/release/llorllale/go-gitlint.svg?style=flat-square)](https://github.com/marmotedu/go-gitlint/releases/latest)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/marmotedu/go-gitlint?style=flat-square)](https://goreportcard.com/report/github.com/marmotedu/go-gitlint)
...
[![Go Doc](https://img.shields.io/badge/godoc-reference-blue.svg?style=flat-square)](http://godoc.org/github.com/marmotedu/go-gitlint)
...
Usage: ./download-gitlint.sh [-b] bindir [-d] [tag]
  ...
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/marmotedu/go-gitlint/releases
